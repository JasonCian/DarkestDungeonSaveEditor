...
public class DataPathsDialog {
    ...
    public DataPathsDialog(Window owner, String gameDir, String modsDir, StateManager state, boolean skipInsteadOfCancel) {
        ...
        Task<Void> task = new Task<Void>() {
            ...
            protected Void call() throws Exception {
                try {
                    ...
                    // 生成名称文件
                    String[] dirs = modsDirectory.isEmpty() ? 
                        new String[]{gameDirectory} : 
    ...
    public static void showDialog(Window owner, String gameDir, String modsDir, StateManager state, boolean skipInsteadOfCancel) {
